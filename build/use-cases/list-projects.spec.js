...
var ListProjectsUseCase = class {
  constructor(projectsRepository2) {
...
// src/use-cases/list-projects.spec.ts
...
describe("List Project Use Case", () => {
  ...
  it("should be able to list non-deleted projects", async () => {
    ...
    globalExpect(projects).toHaveLength(2);
    globalExpect(projects).toEqual([
      globalExpect.objectContaining({ name: "Project 2" }),
      globalExpect.objectContaining({ name: "Project 3" })
    ]);
  });
});
