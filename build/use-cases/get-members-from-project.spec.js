...
var GetMembersFromProjectUseCase = class {
  constructor(projectsRepository2, usersRepository2) {
...
// src/use-cases/get-members-from-project.spec.ts
...
describe("Get Members From Project Use Case", () => {
  ...
  it("should be able to get the members from a specific project", async () => {
    ...
    globalExpect(users).toHaveLength(2);
    globalExpect(users[0].email).toBe(user1.email);
    globalExpect(users[1].email).toBe(user2.email);
  });
