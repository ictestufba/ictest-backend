...
var create_and_authenticate_user_exports = {};
__export(create_and_authenticate_user_exports, {
  createAndAuthenticateUser: () => createAndAuthenticateUser
});
module.exports = __toCommonJS(create_and_authenticate_user_exports);
var import_supertest = __toESM(require_supertest());
async function createAndAuthenticateUser(app) {
  await (0, import_supertest.default)(app.server).post("/users").send({
    name: "John Doe",
